...
class Interaction():
    ...
    def get_response(self, user_utterance, user_utt_topic, res_keywords):
        ...
        if self.gen_model_type =='dialogpt':
            ...
            #slines = ['Sports <EOT> i guess so.  Do you watch espn? <V> extra for espn # regular cable # pay extra # roku # watch']
            #slines = ['Science & Technology <EOT> Those are some strong storms! Considering how many artists are from Canada, I wouldn’t mind tuning into stations that have to play at least 40% Canadian music by law <V> radios during wwii # make radios # true # soldiers']
            with torch.no_grad():
